...
def run_ping():
    ...
    while flag:
        ...
        pygame.draw.circle(my_win, pygame.color.Color("black"), (int(width / 2), int(height / 2)),
                           125)

        pygame.draw.circle(my_win, pygame.color.Color("lightblue"),
                           (int(width / 2), int(height / 2)), 123)
